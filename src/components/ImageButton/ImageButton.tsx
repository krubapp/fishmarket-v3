...
export function ImageButton({
  ...
  return (
    <button
      type="button"
      className={`group relative inline-block shrink-0 overflow-hidden rounded-[4px] transition-colors focus:outline-none focus:ring-2 focus:ring-slate-900 focus:ring-offset-2 ${
