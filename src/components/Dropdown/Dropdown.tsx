...
function ItemRow({
  ...
  return (
    <button
      ...
      className={`flex w-full items-center gap-2 px-2 py-2 text-left font-semibold text-[length:var(--font-size-paragraph-sm)] leading-[1.43] transition-[color,background-color,transform] duration-(--duration-press) ease-(--ease-spring) active:scale-[0.98]
        ...
        ${item.disabled
          ...
          : isError
            ? selected
              ...
              : "bg-white text-red-600 hover:bg-red-50 hover:text-red-700 focus-visible:bg-white active:bg-red-50"
            : selected
